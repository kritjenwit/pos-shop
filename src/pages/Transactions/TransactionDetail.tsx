...
export default function TransactionDetailPage() {
  ...
  return (
    <div className="max-w-md mx-auto space-y-4">
      ...
      <div className="rounded-lg shadow-sm p-5" style={{ backgroundColor: COLORS.cardBackground }}>
      ...
      <div className="rounded-lg shadow-sm p-5" style={{ backgroundColor: COLORS.cardBackground }}>
        ...
        <div className="text-center">
          <div className="inline-block p-4 rounded-lg mb-3" style={{ backgroundColor: '#ffffff' }}>
          ...
          <button
            ...
            className="flex items-center gap-2 mx-auto text-sm px-3 py-1.5 rounded-lg"
            style={{
              backgroundColor: copied ? `${COLORS.accent}15` : `${COLORS.primary}15`,
